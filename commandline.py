            ...
            if s==False:
                ...
                while True:
                    ...
                    if i1==1:
                        ...
                        print("Event Name: " +str(d['Name']))
                        print("Organizer: " +str(d['Organizer']))
                        print("Start Date: " +str(d['Start Date']))
                        print("Start Time: " +str(d['Start Time']))
                        print("End Date: " +str(d['End Date']))
                        print("End Time: " +str(d['End Time']))
                        print("Total Seats: "+str(d["Capacity"]))
                        print("Seats Available: "+str(d['Seats Available']))
                        print('\n')
                    elif i1==4:
                        print("Enter Event ID:")
                        ev_id=input()
